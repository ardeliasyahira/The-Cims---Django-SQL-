...
from .views import list_pemain_menggunakan_apparel, list_admin_menggunakan_apparel, create_menggunakanapparel
...
urlpatterns = [
    ...
    path('pemain/create_menggunakan_apparel', create_menggunakanapparel, name='create_menggunakanapparel'),
]